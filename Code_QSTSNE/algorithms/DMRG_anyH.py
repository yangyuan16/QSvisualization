...
def dmrg_finite_size(para=None):
    ...
    A = Mob(length=para['l'], d=para['d'], chi=para['chi'], way='qr', ini_way=para['ini_way'],
            ...
            is_env_parallel_lmr=para['isParallelEnvLMR'],load=para['load'])
